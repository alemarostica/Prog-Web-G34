...
<fieldset class="cookie">
    ...
    <a href="<%=response.encodeURL(".")%>?accettaCookies=true" style="background-color: greenyellow; width: 50%;" onclick=""> Accetta Cookies</a>
    <a href="<%=response.encodeURL(".")%>" style="float: right; background-color: orangered; width: 50%;"> Rifiuta Cookies</a>
</fieldset>
